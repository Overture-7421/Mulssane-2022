...
{
  double yAxis = -joystick.GetRawAxis(1) * 12;
  double xAxis = -joystick.GetRawAxis(0) * 12;


  swerve.SetVoltage(xAxis, yAxis);

   frc::SmartDashboard::PutNumber("CANCoder Position", swerve.returnPosition());
}
