...
class Shooter : public frc2::SubsystemBase {
 ...
 private:
  ...
  // Volts
  static constexpr auto kFlywheelKs = 0.5496_V;

  // Volts per (radian per second)
  static constexpr auto kFlywheelKv = 0.017152_V / 1_rad_per_s;

  // Volts per (radian per second squared)
  static constexpr auto kFlywheelKa = 0.0012162_V / 1_rad_per_s_sq;

  frc2::PIDController shooterController{0.014725, 0, 0};
